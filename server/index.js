...
initVPN().then(() => {
	...
	mongoose.connect(`mongodb+srv://${process.env.MONGO_USER}:${process.env.MONGO_PASS}@${process.env.MONGO_IP}/${process.env.MONGO_DBNAME}?retryWrites=true&w=majority`,
	...
	app.get("/", (req, res) => {
		res.send("Interactive Lab Systems API Server.");
	});
